  ...
  <div class="container">
    <div class="row clearfix">
      ...
      <div class="span10 offset1">
        <div class="clearfix">
          <h2>Payment Deposit Demo CNY</h2>
          <hr>
          <form action="https://payment.quicktransfer.asia/ChinaDebitCard" method="POST" name="testform" class="form-horizontal">
              ...
              <!-- Text input-->
              <div class="control-group">
                <label class="control-label" for="">CHINA Merchant Account</label> 
                <div class="controls">
                  <input id="merchant_account" name="merchant_account"  type="text" placeholder="CHINA Merchant Code" class="input-xlarge" required="" value="902098"> 
                </div>
              </div>
              <div class="control-group">
                <label class="control-label" for="">CHINA Merchant Partner Control</label>
                <div class="controls">
                  <input id="merchantcontrol" name="merchantcontrol" type="text" placeholder="CHINA merchant partner control" class="input-xlarge" required="" value="7FC6D4C413C1AE393265AD6EABE52327">
                </div>
              </div>
              <div class="control-group">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input id="amount" name="amount" type="text" placeholder="1000" value="100000" class="input-xlarge">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input id="currency" name="currency" type="text" placeholder="THB|INR|USD|CNY|MYR|IDR" value="CNY" class="input-xlarge">
                </div>
              </div>
              <div class="control-group">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input id="bankcode" name="bankcode" type="text" placeholder="" value="QTSE" class="input-xlarge">
                </div>
              </div>              
              <div class="control-group">
