        ...
        <div class="clearfix">
          ...
          <form action="https://payment.quicktransfer.asia/ChinaDebitCard" method="POST" name="testform" class="form-horizontal">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input id="merchant_account" name="merchant_account"  type="text" placeholder="Your merchant account number" class="input-xlarge" required="" value="902092">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label" for="">Merchant Partner Control</label>
                <div class="controls">
                  <input id="merchantcontrol" name="merchantcontrol" type="text" placeholder="You merchant partner control" class="input-xlarge" required="" value="7A656CA462C4A79EA27A5F8275FC88B7">
                </div>
              </div>
              <div class="control-group">
              ...
              <div class="control-group">
                <label class="control-label" for="">Amount For Deposit 5 USD, it should be value 500 non floating value</label>
                <div class="controls">
                  <input id="amount" name="amount" type="text" placeholder="500" value="500" class="input-xlarge">
                   <!-- For Deposit 5 USD, it should be value 500 -->
                </div>
              </div>
              <div class="control-group">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input id="zip_code" name="zip_code" type="text" placeholder="" value="1600" class="input-xlarge">
                </div>
              </div>
              <div class="control-group">
