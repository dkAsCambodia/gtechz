        ...
        <div class="clearfix">
          ...
          <form action="https://payment.quicktransfer.asia/Credit" method="POST" name="testform" class="form-horizontal" enctype="application/x-www-form-urlencoded">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input id="merchantaccount" name="merchantaccount"  type="text" placeholder="Your merchant account" class="input-xlarge" required="" value="902099">
                </div>
              </div>
			  <!-- Text input-->
              <div class="control-group">
                ...
                <div class="controls">
                  <input id="merchantcontrol" name="merchantcontrol" type="text" placeholder="You merchant partner control" class="input-xlarge" required="" value="1300400043CA5837DDE95474193D5F31">
                </div>
              </div>
