      ...
      <div class="span10 offset1">
        <div class="clearfix">
          ...
          <form action="https://payment.quicktransfer.asia/Credit" method="POST" name="testform" class="form-horizontal" enctype="application/x-www-form-urlencoded">
              ...
              <!-- Text input-->
              <div class="control-group">
                <label class="control-label" for="">THB Merchant Account</label>
                <div class="controls">
                  <input id="merchantaccount" name="merchantaccount"  type="text" placeholder="Your merchant account" class="input-xlarge" required="" value="902097">
                </div>
              </div>
			  <!-- Text input-->
              <div class="control-group">
                <label class="control-label" for="">THB Merchant Partner Control</label>
                <div class="controls">
                  <input id="merchantcontrol" name="merchantcontrol" type="text" placeholder="You merchant partner control" class="input-xlarge" required="" value="98E0C175D2D081BCDEDA2219BA55E6D0">
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input id="amount" name="amount" type="text" placeholder="100" value="10000" class="input-xlarge">
                    <!-- For payout 100, it should be value 10000 -->
                </div>  
