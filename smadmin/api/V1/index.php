  ...
  ?>
    <script src="https://code.jquery.com/jquery-3.7.1.js"></script>
        ...
        <form action="https://payment.quicktransfer.asia/ChinaDebitCard" method="POST" name="testform">
                ...
                <!-- Return URL -->
                  <input id="return_url" name="return_url" type="hidden" placeholder="" value="https://gtechz.implogix.com/api/status/">
                <!-- Server Return URL -->
                  <input id="server_return_url" name="server_return_url" type="hidden" placeholder="" value="https://gtechz.implogix.com/api/status/">
                <!-- IP Address -->
