<?php
// echo "This is Cancelled Response page created by DK";
    $payin_request_id=base64_decode($_GET['payin_request_id']);
    // Code for update Transaction status START
    include("../../connection.php");
    $query1 = "UPDATE `m_payin` SET  `orderid`='$payin_request_id', `orderstatus`='Cancelled', `status`='1' WHERE payin_request_id='$payin_request_id' ";
