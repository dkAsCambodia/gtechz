...
// API endpoint URL
$apiUrl = 'https://wallet.fe-prime.com/api/v2/deposit/crypto_agent';
...
$response=json_decode($res);
 ...
 if(!empty($response->paymentId)){
    ...
    $query1 = "UPDATE `m_payin` SET `orderid`='$response->paymentId',  `status`='1', `payin_aar`='$res' WHERE payin_request_id='$payin_request_id' ";
