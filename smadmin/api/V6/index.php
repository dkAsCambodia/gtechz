...
if(!empty($_POST)){
    ...
    $Key= MD5($Keystring);
        ...
        // curl_setopt($curl, CURLOPT_URL, 'https://service.powerpay88test.com/MerchantPayout/PA020');        // for powerpay88 staging
        curl_setopt($curl, CURLOPT_SSL_VERIFYPEER, false);
        curl_setopt($curl, CURLOPT_SSL_VERIFYHOST, 0);
        curl_setopt($curl, CURLOPT_USERAGENT, $_SERVER['HTTP_USER_AGENT']);
        curl_setopt($curl, CURLOPT_REFERER, $source_url);
        curl_setopt($curl, CURLOPT_POST, 1);
        curl_setopt($curl, CURLOPT_POSTFIELDS, array('Key' => $Key,'ClientIP' => $client_ip,'ReturnURI' => 'https://gtechz.implogix.com/api/V6/powerpayResponse.php','MerchantCode' => $Merchant,
