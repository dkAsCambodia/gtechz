          ...
          <div class="col-sm-6">
           ...
           <li class="breadcrumb-item"><a href="<?php echo base_url('administrator/dashboard'); ?>">Home</a></li>
              <li class="breadcrumb-item"><a href="<?php echo base_url('administrator/account_dashboard'); ?>">Dashboard</a></li>
          	  <li class="breadcrumb-item active"><a href="<?php echo site_url();?>administrator/accounts/create-gateways">Add Payment Gateway</a></li>
              <li class="breadcrumb-item"><a href="<?php echo site_url();?>administrator/accounts/gateways">List Payment Gateways</a></li>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Add Payment Gateways </h3>
          ...
          <!-- /.card-header -->
           ...
           <?php echo form_open_multipart('administrators/accounts/create_gateways'); ?>
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                <div class="form-group">
                  <label>Payment Gateway Query</label>
