          ...
          <div class="col-sm-6">
           ...
           <li class="breadcrumb-item"><a href="<?php echo base_url('administrator/dashboard'); ?>">Home</a></li>
              <li class="breadcrumb-item"><a href="<?php echo base_url('administrator/account_dashboard'); ?>">Dashboard</a></li>
          	  <li class="breadcrumb-item active"><a href="<?php echo site_url();?>administrator/accounts/create-wallets">Add Payment Wallets</a></li>
              <li class="breadcrumb-item"><a href="<?php echo site_url();?>administrator/accounts/wallets">List Payment Wallets</a></li>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Add Payment Wallets </h3>
          ...
          <!-- /.card-header -->
           ...
           <?php echo form_open_multipart('administrator/accounts/create-wallets'); ?>
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Payment Wallet Name</label>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                <div class="form-group">
                  <label>Payment Wallet Query</label>
       ...
       Please enter Wallet info image with aspect ratio and set a status for it.
          </div>
        </div>
        <!-- /.card -->
