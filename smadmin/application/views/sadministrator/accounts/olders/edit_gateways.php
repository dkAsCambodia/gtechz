    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <?php echo form_open_multipart('administrators/accounts/update_gateways'); ?>
              ...
              <!-- /.col -->
               ...
               <div class="col-md-12 col-lg-6 col-xl-4">
                <div class="card mb-2 bg-gradient-dark">
                   ...
                   <a href="<?php echo base_url(); ?>assets/images/payments/<?php echo $post['lgo'];?>" data-toggle="lightbox" data-title="<?php echo $post['wname']; ?>">
                  <img style="padding:10px" class="card-img-top img-fluid mb-2" src="<?php echo base_url(); ?>assets/images/payments/<?php echo $post['lgo'];?>" alt="<?php echo base_url(); ?>assets/images/payments/<?php echo $post['lgo']; ?>">
          ...
          <div class="card-footer">
           PleaseEdit Payment Gateway Info with image with aspect ratio and set a status for it.
          </div>
        </div>
        <!-- /.card -->
