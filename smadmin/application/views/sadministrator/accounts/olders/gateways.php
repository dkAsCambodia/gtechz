          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url('administrator/account_dashboard'); ?>">Dashboard</a></li>
          	  <li class="breadcrumb-item"><a href="<?php echo site_url();?>administrator/accounts/create-gateways">Add Payment Gateway</a></li>
              <li class="breadcrumb-item active"><a href="<?php echo site_url();?>administrator/accounts/gateways">List Payment Gateways</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Manage Payment Gateways Information </h3>
              </div>
              <!-- /.card-header -->
                   ...
                   <?php $i=1; foreach($posts as $blog) : ?>
                                  <tr>
                                        <td><?php echo $i++; //$blog['id']; ?></td>
                                         ...
                                         <td>
                                          <a href="<?php echo site_url();?>assets/images/payments/<?php echo $blog['lgo'];  ?>"  data-toggle="lightbox" data-title="<?php echo $blog['wname']; ?>" alt="<?php echo $blog['wname']; ?>">
                                            <img width="30px;" src="<?php echo site_url();?>assets/images/payments/<?php echo $blog['lgo'];  ?> "></a></td>
                                        ...
                                        <td align="left">
                                               ...
                                               <a class="btn btn-success btn-sm enable" href='<?php echo base_url(); ?>administrator/enableoth/<?php echo $blog['id']; ?>?table=<?php echo base64_encode('gateways'); ?>'>Enabled</a>
                                                <?php }else{ ?> 
                                                <a class="btn btn-warning btn-sm disable" href='<?php echo base_url(); ?>administrator/desableoth/<?php echo $blog['id']; ?>?table=<?php echo base64_encode('gateways'); ?>'>Disabled</a>
                                                <?php } ?>
                                                <!-- Edit Button label label-inverse-primary -->
                                                <a class="btn btn-info btn-sm" href='<?php echo base_url(); ?>administrators/accounts/edit_gateways/<?php echo $blog['id']; ?>'><i class="fas fa-edit">&nbsp;</i>Edit</a>
                                                <!-- Delete Button <i class="fas fa-edit"></i>-->
                                                <a class="btn btn-danger btn-sm delete" href='<?php echo base_url(); ?>administrators/accounts/deletegateways/<?php echo $blog['id']; ?>?table=<?php echo base64_encode('gateways'); ?>'><i class="fas fa-trash">&nbsp;</i> Delete</a>
