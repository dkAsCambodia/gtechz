              ...
              <div class="col-lg-6 col-sm-12 col-md-6 col-xl-6">
                <div class="card overflow-hidden">
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        <a href="#" class="" data-bs-target="#Verticallyz" data-bs-toggle="modal" >test
                        </a>
                          <a href="#" class="" data-bs-target="#modaldemo1" data-bs-toggle="modal" >
                      ...
                      <div class="table-responsive export-table">
                        <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom  w-100" >
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td class="text-muted fs-12 fw-semibold"><a href="#" class="text-dark" data-bs-target="#Vertically" data-bs-toggle="modal" ><?php echo $i++; //$blog['id']; ?></a></td>
                              <td class="text-muted fs-12 fw-semibold"><a href="#" class="text-dark" data-bs-target="#Vertically" data-bs-toggle="modal" ><?php echo $blog['ac_name']; ?></a></td>
                              ...
                              <td class="text-muted fs-12 fw-semibold">
                                <div class="d-flex align-items-stretch">
                                  ...
                                  <a class="btn btn-sm btn-outline-primary border me-2" data-bs-toggle="tooltip" data-bs-original-title="Active"  href='<?php echo base_url(); ?>sadministrator/enableoth/<?php echo $blog['id']; ?>?table=<?php echo base64_encode('m_banks'); ?>'>
                                  ...
                                  <?php }else{ ?> 
                                  <a class="btn btn-sm btn-outline-secondary border me-2" data-bs-toggle="tooltip" data-bs-original-title="Hold" href='<?php echo base_url(); ?>sadministrator/desableoth/<?php echo $blog['id']; ?>?table=<?php echo base64_encode('m_banks'); ?>'>
                                    <svg  xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="20" width="16" viewBox="0 0 24 24"><path d="M15.8085327,8.6464844l-5.6464233,5.6464844l-2.4707031-2.4697266c-0.0023804-0.0023804-0.0047607-0.0047607-0.0072021-0.0071411c-0.1972046-0.1932373-0.5137329-0.1900635-0.7069702,0.0071411c-0.1932983,0.1972656-0.1900635,0.5137939,0.0071411,0.7070312l2.8242188,2.8232422C9.9022217,15.4474487,10.02948,15.5001831,10.1621094,15.5c0.1326294,0.0001221,0.2598267-0.0525513,0.3534546-0.1464844l6-6c0.0023804-0.0023804,0.0047607-0.0046997,0.0071411-0.0071411c0.1932373-0.1972046,0.1900635-0.5137329-0.0071411-0.7069702C16.3183594,8.446106,16.0018311,8.4493408,15.8085327,8.6464844z M12,2C6.4771729,2,2,6.4771729,2,12s4.4771729,10,10,10c5.5201416-0.0064697,9.9935303-4.4798584,10-10C22,6.4771729,17.5228271,2,12,2z M12,21c-4.9705811,0-9-4.0294189-9-9s4.0294189-9,9-9c4.9683228,0.0054321,8.9945679,4.0316772,9,9C21,16.9705811,16.9705811,21,12,21z"/></svg>
                                  </a>
                                  <?php } ?>
                                  <a class="btn btn-sm btn-outline-info border me-2" data-bs-toggle="tooltip" data-bs-original-title="View/Edit">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="fill-white" enable-background="new 0 0 24 24" height="20" width="16"  viewBox="0 0 24 24"><path d="M12,8c-2.2091675,0-4,1.7908325-4,4s1.7908325,4,4,4c2.208252-0.0021973,3.9978027-1.791748,4-4C16,9.7908325,14.2091675,8,12,8z M12,15c-1.6568604,0-3-1.3431396-3-3s1.3431396-3,3-3c1.6561279,0.0018311,2.9981689,1.3438721,3,3C15,13.6568604,13.6568604,15,12,15z M21.960022,11.8046875C19.9189453,6.9902344,16.1025391,4,12,4s-7.9189453,2.9902344-9.960022,7.8046875c-0.0537109,0.1246948-0.0537109,0.2659302,0,0.390625C4.0810547,17.0097656,7.8974609,20,12,20s7.9190063-2.9902344,9.960022-7.8046875C22.0137329,12.0706177,22.0137329,11.9293823,21.960022,11.8046875z M12,19c-3.6396484,0-7.0556641-2.6767578-8.9550781-7C4.9443359,7.6767578,8.3603516,5,12,5s7.0556641,2.6767578,8.9550781,7C19.0556641,16.3232422,15.6396484,19,12,19z"/></svg>
                                  </a>
                      ...
                      <!-- <table id="data-table" class="table text-nowrap mb-0 table-bordered"> -->
                        ...
                        <thead class="table-head">
                          <tr>
                            ...
                            <th class="bg-transparent border-bottom-0">Account Holder</th>
                            <th class="bg-transparent border-bottom-0">Acc.Address</th>
                            <th class="bg-transparent border-bottom-0">Acc.Number</th>
                            <th class="bg-transparent border-bottom-0">IFSC/Routing</th>
                            <th class="bg-transparent border-bottom-0">SWIFT</th>
                            <th class="bg-transparent border-bottom-0">Bank Name</th>
                        ...
                        <tbody class="table-body">
                          <tr>
                            <td class="text-muted fs-12 fw-semibold"><a href="#" class="text-dark" data-bs-target="#Vertically" data-bs-toggle="modal" ><?php echo $i++; //$blog['id']; ?></a></td>
                            <td class="text-muted fs-12 fw-semibold"><a href="#" class="text-dark" data-bs-target="#Vertically" data-bs-toggle="modal" ><?php echo $blog['ac_name']; ?></a></td>
                            <td class="text-info fs-12"><?php echo $blog['ac_address']; ?></a></td>
                            <td class="text-primary fs-12 fw-semibold"><?php echo $blog['ac_number']; ?></td>
                            <td class="text-success fs-12 fw-semibold"><?php echo $blog['bank_ifsc']; ?></td>
                            <td class="text-success fs-12 fw-semibold"><?php echo $blog['bank_swiftcode']; ?></td>
                            <td class="text-success fs-12 fw-semibold"><?php echo $blog['bank_name']; ?></td>
                            <td class="text-muted fs-12 fw-semibold"><?php echo $blog['branch_name']; ?></td>
                            <td class="text-info fs-12 fw-semibold"><?php echo $blog['created_date']; ?></td>
                            <td class="text-muted fs-12 fw-semibold"><?php echo $blog['status']; ?></td>
                          </tr>
    ...
    <div class="modal fade" id="Verticallyz"  role="document" >
              ...
              <form class="needs-validation" novalidate>
                        ...
                        <div class="form-row">
                          <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-5">
                            <label for="validationCustom011" class="mb-2 m-0 text-muted text-sm">Name</label>
                            <input type="text" class="form-control form-control-sm" id="validationCustom011" placeholder="Account Holder's Name" value="" required>
                            <div class="valid-feedback">Looks good!</div>
                          </div>
                          <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-5">
                            <label for="validationCustom12" class="mb-2 m-0 text-muted text-sm">Address</label>
                            <input type="text" class="form-control form-control-sm" id="validationCustom12" placeholder="Account Holder's Address" value="" required>
                            <div class="valid-feedback">Looks good!</div>
                          </div>
                        </div>
                        <div class="form-row">
                          <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-5">
                            <label for="validationCustom011" class="mb-2 m-0 text-muted text-sm">Account Number</label>
                            <input type="text" class="form-control form-control-sm" id="validationCustom011" placeholder="Account Number" value="" required>
                            <div class="valid-feedback">Looks good!</div>
                          </div>
                          <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-5">
                            <label for="validationCustom12" class="mb-2 m-0 text-muted text-sm">IFSC/Routing Number</label>
                            <input type="text" class="form-control form-control-sm" id="validationCustom12" placeholder="IFSC/Routing Number" value="" required>
                            <div class="valid-feedback">Looks good!</div>
                          </div>
                        </div>
                        <div class="form-row">
                          <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-5">
                            <label for="validationCustom011" class="mb-2 m-0 text-muted text-sm">SWIFT CODE</label>
                            <input type="text" class="form-control form-control-sm" id="validationCustom011" placeholder="SWIFT CODE" value="" required>
                            <div class="valid-feedback">Looks good!</div>
                          </div>
                          <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-5">
                            <label for="validationCustom12">Bank Name</label>
                            <input type="text" class="form-control form-control-sm" id="validationCustom12" placeholder="Bank Name" value="" required>
                            <div class="valid-feedback">Looks good!</div>
                          </div>
                        </div>
                        <div class="form-row">
                          <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-5">
                            <label for="validationCustom011" class="mb-2 m-0 text-muted text-sm">Bank Address</label>
                            <input type="text" class="form-control form-control-sm" id="validationCustom011" placeholder="Account Holder's Name" value="" required>
                            <div class="valid-feedback">Looks good!</div>
                          </div>
                          <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-5">
                            <label for="validationCustom12" class="mb-1 m-0 text-muted text-sm">Requested Currency</label>
                            <!-- <input type="text" class="form-control form-control-sm" id="validationCustom12" placeholder="Account Holder's Address" value="" required> -->
                            
                          <!-- <div class="form-group"> -->
                          <select id="mySelect4" class="form-control form-control-sm select2-show-search form-select" data-placeholder="Choose one" style="width:100%">
                        ...
                        <div class="form-row">
                          <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-5">
                            <label for="validationCustom13">Bank Address</label>
                            <input type="text" class="form-control form-control-sm" id="validationCustom13" placeholder="Bank Address" value=""  required>
                            <div class="invalid-feedback">Please provide a valid city.</div>
                          </div>
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-5">
                        <div class="form-group">
                          <label class="form-label">Requested Currency</label>
                          ...
                          <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-5">
                            <div class="form-group">
                            <label for="validationCustom14">Requested Currency </label>
