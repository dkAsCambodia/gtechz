      ...
      <div class="app-content main-content mt-0">
        <div class="side-app">
          ...
          <div class="main-container container-fluid">
            ...
            <div class="page-header">
              ...
              <div class="ms-auto pageheader-btn">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"  aria-current="page"><a href="<?php echo base_url('sadministrator/accounts/merchants-wallets'); ?>">Merchant Wallets</a></li>
                </ol>
              </div>
            </div>
            <!-- PAGE-HEADER END -->
            ...
            <input type="hidden" name="mlistwalletac" id="mlistwalletac" value="<?php echo 1; //$post['id']; ?>">
            <div class="row">
            </div>
            <!-- ROW-1 END-->
            <!-- Row -->
                      ...
                      <div class="table-responsive export-table">
                        <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom  w-100" >
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td class="text-muted fs-12 fw-semibold"><a href="#" class="text-dark" data-bs-target="#editmwalletac<?php echo $blog['id'];?>" data-bs-toggle="modal" ><?php echo $i++; //echo $blog['id']; ?></a></td>

                              <td class="text-primary fs-12 fw-semibold">
                                <a href="#" class="text-dark" data-bs-target="#editmwalletac<?php echo $blog['id'];?>" data-bs-toggle="modal" >
                              ...
                              <td class="text-primary fs-12 fw-semibold"><a href="#" class="" data-bs-target="#editmwalletac<?php echo $blog['id'];?>" data-bs-toggle="modal" ><?php echo $blog['merchant_name']; ?></a></td>
                              <td class="text-muted fs-12 fw-semibold"><?php echo $blog['ac_name']; ?></a></td>
                            ...
                            <div class="modal fade editmwalletac" id="editmwalletac<?php echo $blog['id'];?>"  role="document">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-row">
                                          <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-5">
                                            ...
                                            <input type="text" readonly class="form-control form-control-sm" id="edwname" name="edwname" placeholder="Name On Wallet" value="<?php echo $blog['ac_name']; ?>" required>
                                            <div class="valid-feedback">Looks good!</div>
                                          </div>
                                          <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-5">
                                            <label for="edwnetwork" class="mb-2 m-0 text-muted text-sm">Wallet Name</label>
                                            <input type="text" readonly class="form-control form-control-sm" id="edwnetwork" name="edwnetwork" placeholder="Wallet Name" value="<?php echo $blog['ac_network']; ?>" required>
                                            <div class="valid-feedback">Looks good!</div>
                                          </div>
                                        </div>
                                        <div class="form-row">
                                          <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-5">
                                            ...
                                            <input type="text" readonly class="form-control form-control-sm" id="edwaddress" name="edwaddress" placeholder="Address" value="<?php echo $blog['ac_address']; ?>" required>
                                            <div class="valid-feedback">Looks good!</div>
                                          </div>
                                          <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-5">
                                            <label for="edwwallet_provider" class="mb-2 m-0 text-muted text-sm">wallet Provider</label>
                                            <input type="text" readonly class="form-control form-control-sm" id="edwwallet_provider" name="edwwallet_provider" placeholder="Wallet Provider" value="<?php echo $blog['wallet_provider']; ?>" required>
                                            <div class="valid-feedback">Looks good!</div>
                                          </div>
                                          <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-5">
                                            ...
                                            <input class="form-control file-input form-control-sm" id="edwdocument" name="edwdocument" type="file" readonly disabled value="<?php echo $blog['documen']; ?>">
                                          ...
                                          <div id="edwcurrent"  class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-5" >
                                            ...
                                            <select readonly disabled id="edwcurrency" name="edwcurrency" class="form-control form-control-sm select2-show-search form-select" data-placeholder="Choose one">
                                        ...
                                        <div class="form-row">
                                          <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-5">
                                            ...
                                            <input type="number" readonly class="form-control form-control-sm" id="edwfee" name="edwfee" placeholder="Withdraw Fee- %" value="<?php echo $blog['withdrafee']; ?>"  required>
                                            <div class="invalid-feedback">Please provide a valid Number.</div>
                                          </div>
                                          <div class="col-xl-6 col-lg-3 col-md-12 col-sm-12 mb-5">
                                            <label for="edwnickname">Account Nick Name</label>
                                            <input type="text" readonly class="form-control form-control-sm" id="edwnickname" name="edwnickname" placeholder="Account Nick Name" value="<?php echo $blog['nickname']; ?>" >
