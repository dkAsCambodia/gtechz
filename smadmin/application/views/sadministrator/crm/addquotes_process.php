                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      ...
                      <input type="text" readonly required class="form-control form-control-sm" value="customer" required id="custype" name="custype" placeholder="custype">
                ...
                <!--<form class="form-horizontal">-->
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" value="Candid Homes" required id="ordertakenby" readonly name="ordertakenby" placeholder="Order Taken By">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" value="Finished Products" required id="entitycateg" readonly name="entitycateg" placeholder="Enitity Category">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        ...
                        <option <?php if(set_value('salestype') =="General Tax" ){ echo 'selected="selected"'; } ?> value="General Tax">General Tax</option>                                                                                                                         
                        </select>
                      </div>
                    </div>
                     ...
                     <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                         ...
                         <input type="text" readonly required class="form-control form-control-sm" value="Candid Homes" required id="firmname" name="firmname" placeholder="Firm Nam"> 
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                       ...
                       <div class="input-group date" id="billdt2" data-target-input="nearest">
                          <input type="text" required name="pdate" id="pdate" value="<?php if($post['pdate']==""){echo date("d/m/Y h:i:s A", strtotime($post['pdate']));} else echo set_value('pdate');  ?>" class="form-control form-control-sm datetimepicker-input" data-target="#billdt2"/>
