        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
           <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="<?php echo site_url();?>staff/create_customers">Add Customer</a></li>
              <li class="breadcrumb-item"><a href="<?php echo site_url();?>staff/customers">List Customers</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <?php echo form_open_multipart('staff/create_customers'); ?>
       <input type="hidden" name="mproduct_id" id="mproduct_id" value="<?php echo 1; //$post['id']; ?>">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control"  required value="<?php echo set_value('name');  ?>" name="name" placeholder="Customer Name" type="text">
                 ...
                 <div class="form-group">
                  ...
                  <input class="form-control"   value="<?php echo set_value('contact');  ?>" name="contact" placeholder="Alertante Contact" type="text">
                 ...
                 <div class="form-group">
                  ...
                  <input class="form-control"   value="<?php echo set_value('taluk');  ?>" name="taluk" placeholder="Location" type="text">
          ...
          <div class="card-footer">
           Please enter Customer with required fields and set a status for it.
          </div>
        </div>
        <!-- /.card -->
