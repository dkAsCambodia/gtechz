    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <?php echo form_open_multipart('staff/create_leadsmeasurements'); ?>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control form-control-sm"  required readonly value="<?php echo $posts['name'];?>" name="name" placeholder="Customer Name" type="text">
                  <input class="form-control form-control-sm"  required readonly value="<?php echo $posts['user_id'];?>" name="cid" placeholder="Customer ID" type="hidden">
              ...
              <div class="col-md-3">
                 <div class="form-group">
                  ...
                  <select name="resitype" required id="resitype"  class="form-control  form-control-sm select2" style="width: 100%;">
                   ...
                   <option <?php if(set_value ('resitype') =="residential" ){ echo 'selected="selected"'; } ?> value="residential">Residential</option>
                  <option <?php if(set_value ('resitype') =="commercial" ){ echo 'selected="selected"'; } ?> value="commercial">Commercial</option>
               ...
               <div class="col-md-3">
                 <div class="form-group">
                    <label class="text-sm"  for="resitype">RoomType</label>
                        
                  <select name="roomtype" required id="roomtype"  class="form-control  form-control-sm select2" style="width: 100%;">
                   <option value="">Select Any</option>
                   <option <?php if(set_value ('roomtype') =="Living" ){ echo 'selected="selected"'; } ?> value="Living">Living</option>
                  <option <?php if(set_value ('roomtype') =="Hall" ){ echo 'selected="selected"'; } ?> value="Hall">Hall</option>
                  <option <?php if(set_value ('roomtype') =="Kitchen" ){ echo 'selected="selected"'; } ?> value="Kitchen">Kitchen</option>
                  <option <?php if(set_value ('roomtype') =="BedRoom" ){ echo 'selected="selected"'; } ?> value="BedRoom">BedRoom</option>
                  <option <?php if(set_value ('roomtype') =="Dining" ){ echo 'selected="selected"'; } ?> value="Dining">Dining</option>
              ...
              <div class="col-md-6">
                 <div class="form-group">
                  ...
                  <option <?php if($product['name'] ==set_value('materialtype')){ echo 'selected="selected"'; } ?> value="<?php echo $product['name'] ?>"><?php echo $product['name']?> </option>
                  <?php } ?>
                  </select>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control form-control-sm"  required  value="<?php echo set_value('materialname');?>" name="materialname" placeholder="Material Name" type="text">
              ...
              <div class="col-md-4">
                 <div class="form-group">
                  ...
                  <input class="form-control number  form-control-sm"  required value="<?php echo set_value('width');  ?>" name="width"  id="width" placeholder="Width" type="text">
              ...
              <div class="col-md-4">
                 <div class="form-group">
                  ...
                  <input class="form-control number  form-control-sm"  required value="<?php echo set_value('height');  ?>" name="height"  id="height" placeholder="Height" type="text">
              ...
              <div class="col-md-4">
                 <div class="form-group">
                  ...
                  <input class="form-control number  form-control-sm" readonly  required value="0" name="sqft" id="sqft" placeholder="Sq.Ft" type="text">
