          ...
          <div class="col-sm-6">
           <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a  class="btn-sm btn bg-info" href="<?php echo base_url('staff/dashboard'); ?>">Home</a></li>
          	  <!-- <li class="breadcrumb-item"><a href="<?php //echo site_url();?>staff/create_customers">Add Customer</a></li> -->
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
         <?php if($this->session->flashdata('success')): ?>
          ...
          <?php echo form_open_multipart('staff/update_customers'); ?>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control"  required value="<?php if(set_value('name')=="") echo $post['name']; else echo set_value('name');  ?>" name="name" placeholder="Customer Name" type="text">
                 ...
                 <div class="col-md-6">
                 <div class="form-group">
                  <label>Alertante Contact</label>
                  <input class="form-control"   value="<?php if(set_value('contact')=="") echo $post['contact']; else echo set_value('contact');  ?>" name="alternate_contact" placeholder="Alertante Contact" type="text">
                ...
                <div class="col-md-12">
                 ...
                 <div class="form-group">
                  ...
                  <input class="form-control"   value="<?php if(set_value('taluk')=="") echo $post['taluk']; else echo set_value('taluk');  ?>" name="taluk" placeholder="Location" type="text">
          ...
          <div class="card-footer">
           Please enter required fields and set a status for it.
          </div>
        </div>
        <!-- /.card -->
