...
<section class="content">
  <div class="container-fluid">
    ...
    <div class="card card-default">
      ...
      <?php echo form_open_multipart('staff/update_leadsp'); ?>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      ...
                      <select disabled name="referal"  id="referal" required class="form-control form-control-sm select2" style="width: 100%;">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <select name="requiredfor" disabled  id="requiredfor" required class="form-control form-control-sm select2" style="width: 100%;">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" readonly minlength="3" maxlength="6"  class="form-control form-control-sm number amc" value="<?php echo $post['totarea'];  ?>" required id="totarea" name="totarea" placeholder="Total Area Required">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <select disabled name="csuggesttime"  id="csuggesttime" required class="form-control form-control-sm select2" style="width: 100%;">
                ...
                <!--<form class="form-horizontal">-->
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                       ...
                       <div class="input-group date" id="billdt2" data-target-input="nearest">
                          <input type="text" required name="pdate" id="pdate" value="<?php if(set_value('pdate')==""){echo date("d/m/Y h:i:s A", strtotime($post['pdate']));} else echo set_value('pdate');  ?>" class="form-control form-control-sm datetimepicker-input" data-target="#billdt2"/>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <textarea readonly  class="form-control form-control-sm" required value="<?php echo $post['custremarks'];  ?>" name="custremarks" id="custremarks" placeholder="Customer Remarks" ><?php echo $post['custremarks'];  ?></textarea>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" value="<?php echo $post['leadcordremarks'];  ?>" readonly  required id="leadcordremarks" name="leadcordremarks" placeholder="Lead Coordinator Remarks">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input readonly type="hidden" class="form-control"  value="<?php if($post['categoryname']!="") echo $post['categoryname'] ;  ?>"  id="categoryname" name="categoryname" placeholder="Enter Category">
                        <select disabled name="category" required id="category"  class="form-control form-control-sm  select2" style="width: 100%;">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input readonly type="hidden" class="form-control" id="subcategoryid" value="<?php if($post['subcat_id']!="") echo $post['subcat_id'] ;  ?>" name="subcategoryid" placeholder="Enter Sub Category">

                        <input readonly type="hidden" class="form-control"  value="<?php if($post['subcategoryname']!="") echo $post['subcategoryname'] ;  ?>"  id="subcategoryname" name="subcategoryname" placeholder="Enter Sub Category">
                      
                        <select disabled name="subcategory" required  id="subcategory"  class="form-control form-control-sm select2" style="width: 100%;">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input readonly type="hidden" class="form-control"  value="<?php if($post['inquryassigneduser']!="") echo $post['inquryassigneduser'] ;  ?>"  id="inquryassignedusername" name="inquryassignedusername" placeholder="Enter Inquiry Assigned User">
                        <select disabled name="inquryassigneduser" required id="inquryassigneduser" class="form-control form-control-sm select2" style="width: 100%;">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="hidden" class="form-control"  value="<?php if($post['executivename']!="") echo $post['executivename'] ;  ?>"  id="executivenamez" name="executivenamez" placeholder="Enter Executive Name">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" value="<?php echo $post['executivecontact'];  ?>" readonly required id="executivecontact" name="executivecontact" placeholder="Executive Contact">
                      </div>
                    </div>
                  </div>
                  <!-- /.card-body -->
