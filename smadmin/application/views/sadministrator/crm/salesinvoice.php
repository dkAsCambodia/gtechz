                                  ...
                                  <tr>
                                     ...
                                     <!-- d/m/Y h:i:s A; -->
                                      ...
                                      <td  align="left" >
                                       ...
                                       <a class="text-danger" href='<?php echo base_url(); ?>staff/viewsales-payments/<?php echo trim($post['bill_no']); ?>/<?php echo $post['id']; ?>'><i class="fas fa-arrow-alt-circle-right"></i></a>
                                      </td>
                                      <td>
                                      <a class="text-danger" target="_blank" href='<?php echo base_url(); ?>staff/viewsales-invoice/<?php echo $post['order_id']; ?>'><i class="fas fa-file-pdf"></i></a>
                                      </td>
                                      <td>
                                      </td>
