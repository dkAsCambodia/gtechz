                   ...
                   <?php $i=1; foreach($posts as $blog) : ?>
                                  <tr>
                                        <td><?php echo $i++; //$blog['id']; ?></td>
                                         ...
                                         <td><?php echo $blog['subname']; ?></td>
                                        
                                        
                                        <td align="left">
                                                <?php if($blog['subcatstatus'] == 1){ ?>
                                               <a class="btn btn-success btn-sm enable" href='<?php echo base_url(); ?>staff/enableoth/<?php echo $blog['id']; ?>?table=<?php echo base64_encode('subcategories'); ?>'>Enabled</a>
                                                <?php }else{ ?> 
                                                <a class="btn btn-warning btn-sm disable" href='<?php echo base_url(); ?>staff/desableoth/<?php echo $blog['id']; ?>?table=<?php echo base64_encode('subcategories'); ?>'>Disabled</a>
                                                <?php } ?>
                                                <!-- Edit Button label label-inverse-primary -->
                                                <a class="btn btn-info btn-sm" href='<?php echo base_url(); ?>staff/edit_subcategories/<?php echo $blog['id']; ?>'><i class="fas fa-edit">&nbsp;</i>Edit</a>
                                                <!-- Delete Button <i class="fas fa-edit"></i>-->
                                                <a class="btn btn-danger btn-sm delete" href='<?php echo base_url(); ?>staff/deletesubcategories/<?php echo $blog['id']; ?>?table=<?php echo base64_encode('subcategories'); ?>'><i class="fas fa-trash">&nbsp;</i> Delete</a>
