        ...
        <div class="side-app">
           ...
           <div class="main-container container-fluid">
            ...
            <div class="page-header">
              <div>
                <h1 class="page-title"><?php echo $title; ?> - Dashboard Transactions</h1>
              </div>
                    ...
                    <div class="table-responsive">
                      <table id="data-table" class="table text-nowrap mb-0 table-bordered">
                        <thead class="table-head">
                          <tr>
                            <th class="bg-transparent border-bottom-0 wp-15">Payment ID</th>
                            <th class="bg-transparent border-bottom-0">i</th>
                            <th class="bg-transparent border-bottom-0">M.OrderId</th>
                            <th class="bg-transparent border-bottom-0">Customer Name</th>
                            <th class="bg-transparent border-bottom-0">Order Amt</th>
                            <th class="bg-transparent border-bottom-0">Trans Amt</th>
                            <th class="bg-transparent border-bottom-0">Balance</th>
                            <th class="bg-transparent border-bottom-0">Timestamp</th>
                            <th class="bg-transparent border-bottom-0">So.</th>
                            <th class="bg-transparent border-bottom-0">Reason</th>
                            <th class="bg-transparent border-bottom-0">Acquirer</th>
                            <th class="bg-transparent border-bottom-0">Status</th>
                            <th class="bg-transparent border-bottom-0">Receiver</th>
                            <th class="bg-transparent border-bottom-0">Card No.</th>
                            <th class="bg-transparent border-bottom-0">Bank Response</th>
                            <th class="bg-transparent border-bottom-0">Post Josn</th>
                            <th class="bg-transparent border-bottom-0">Order Currency</th>
                            <th class="bg-transparent border-bottom-0 no-btn">Order Set</th>
                          </tr>
                        </thead>
                        <tbody class="table-body">
                          <tr>
                            <td class="text-muted fs-14 fw-semibold"><a href="#" class="text-dark" data-bs-target="#Vertically" data-bs-toggle="modal" >40421630606</a></td>
                            <td class="text-muted fs-14 fw-semibold"><a href="#" class="text-dark" data-bs-target="#Vertically" data-bs-toggle="modal" >i</a></td>
                            <td class="text-info fs-14 fw-semibold">2421672315560</a></td>
                            <td class="text-primary fs-14 fw-semibold">491</td>
                            <td class="text-success fs-14 fw-semibold">฿6,000.00</td>
                            <td class="text-success fs-14 fw-semibold">฿0.00</td>
                            <td class="text-success fs-14 fw-semibold">฿0.00</td>
                            <td class="text-muted fs-14 fw-semibold">12/30/22 12:22	</td>
                            <td class="text-info fs-14 fw-semibold">So</td>
                            <td class="text-muted fs-14 fw-semibold">Cancelled Payment</td>
                            <td class="text-muted fs-14 fw-semibold">THAIQR</td>
                            <td class="text-danger fs-14 fw-semibold">Cancelled</td>
                            <td class="text-muted fs-14 fw-semibold"><a href="#" class="text-dark" data-bs-target="#Vertically" data-bs-toggle="modal" >Grandconcert</a></td>
                            <td class="text-muted fs-14 fw-semibold">565784995</td>
                            <td class="text-muted fs-14 fw-semibold">5666767677</td>
                            <td class="text-muted fs-14 fw-semibold">6734342345</td>
                            <td class="text-muted fs-14 fw-semibold">THB</td>
                            <td class="text-muted fs-14 fw-semibold">40421630606_1491_11248_2421672315560_0</td>
                          </tr>
                          <tr>
                            <td class="text-muted fs-14 fw-semibold"><a href="#" class="text-dark" data-bs-target="#Vertically" data-bs-toggle="modal" >40421630605</a></td>
                            <td class="text-muted fs-14 fw-semibold"><a href="#" class="text-dark" data-bs-target="#Vertically" data-bs-toggle="modal" >i</a></td>
                            <td class="text-info fs-14 fw-semibold">2421672315660</a></td>
                            <td class="text-primary fs-14 fw-semibold">490</td>
                            <td class="text-success fs-14 fw-semibold">฿6,000.00</td>
                            <td class="text-success fs-14 fw-semibold">฿0.00</td>
                            <td class="text-success fs-14 fw-semibold">฿0.00</td>
                            <td class="text-muted fs-14 fw-semibold">12/30/22 12:22	</td>
                          ...
                          <tr>
                            <td class="text-muted fs-14 fw-semibold"><a href="#" class="text-dark" data-bs-target="#Vertically" data-bs-toggle="modal" >40421630603</a></td>
                            <td class="text-muted fs-14 fw-semibold"><a href="#" class="text-dark" data-bs-target="#Vertically" data-bs-toggle="modal" >i</a></td>
                            <td class="text-info fs-14 fw-semibold">2421672315760</a></td>
                            <td class="text-primary fs-14 fw-semibold">492</td>
                            <td class="text-success fs-14 fw-semibold">฿6,000.00</td>
                            <td class="text-success fs-14 fw-semibold">฿0.00</td>
                            <td class="text-success fs-14 fw-semibold">฿0.00</td>
                            <td class="text-muted fs-14 fw-semibold">12/30/22 12:22	</td>
