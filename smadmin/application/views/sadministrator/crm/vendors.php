                                  ...
                                  <tr>
                                       ...
                                       <td><?php echo $i++;//$post['user_id']; ?></td>
                                        ...
                                        <td  align="left">
                                               ...
                                               <a class="btn btn-success btn-sm enable" href='<?php echo base_url(); ?>staff/enable/<?php echo $post['user_id']; ?>?table=<?php echo base64_encode('vendors'); ?>'>Enabled</a>
                                                <?php }else{ ?> 
                                                <a class="btn btn-warning btn-sm disable" href='<?php echo base_url(); ?>staff/desable/<?php echo $post['user_id']; ?>?table=<?php echo base64_encode('vendors'); ?>'>Disabled</a>
                                                <?php } ?>
                                                
                                                 <!-- Edit Button -->
                                                <a class="btn btn-info btn-sm" href='<?php echo base_url(); ?>staff/edit_vendors/<?php echo $post['user_id']; ?>'><i class="fas fa-edit">&nbsp;</i>&nbsp;Edit</a>
                                             
                                                <!-- Delete Button -->
                                                	
                                                <a class="btn btn-danger btn-sm delete" href='<?php echo base_url(); ?>staff/deletevendors/<?php echo $post['user_id']; ?>'><i class="fas fa-trash">&nbsp;</i>&nbsp;Delete</a>
                                        </td>
