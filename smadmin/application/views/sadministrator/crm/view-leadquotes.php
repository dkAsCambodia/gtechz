                                     ...
                                     <!-- d/m/Y h:i:s A; -->
                                      ...
                                      <td  align="left" >
                                        <?php if($post['leadstatus']=="Lead In Pipeline"){?>
                                          <small><a title="<?php echo $post['leadstatus']; ?>" class='px-2 bg-info' href='<?php echo base_url(); ?>staff/edit_leads/<?php echo $post['order_id']; ?>'><?php echo $post['leadstatus']; ?></a></small>
                                        
                                        <?php } else if($post['leadstatus']=="CPO Approval Pending"){?>
                                          <small><a title="<?php echo $post['leadstatus']; ?>" class='px-2 bg-success' href='<?php echo base_url(); ?>staff/edit_leads/<?php echo $post['order_id']; ?>'><?php echo $post['leadstatus']; ?></a></small>

                                        <?php } else if($post['leadstatus']=="Meeting Proposed"){?>
                                          <small><a title="<?php echo $post['leadstatus']; ?>" class='px-2 bg-warning' href='<?php echo base_url(); ?>staff/edit_leads/<?php echo $post['order_id']; ?>'><?php echo $post['leadstatus']; ?></a></small>

                                        <?php } else if($post['leadstatus']=="Presentation Given"){?>
                                          <small><a title="<?php echo $post['leadstatus']; ?>" class='px-2 bg-pink' href='<?php echo base_url(); ?>staff/edit_leads/<?php echo $post['order_id']; ?>'><?php echo $post['leadstatus']; ?></a></small>

                                        <?php } else if($post['leadstatus']=="Lead Cancelled"){?>
                                          <small><a title="<?php echo $post['leadstatus']; ?>" class='px-2 bg-danger' href='<?php echo base_url(); ?>staff/edit_leads/<?php echo $post['order_id']; ?>'><?php echo $post['leadstatus']; ?></a></small>
                                      ...
                                      <td  align="left">
                                        <a class="text-primary" href='<?php echo base_url(); ?>staff/view_leads/<?php echo $post['order_id']; ?>'><i class="fas fa-eye"></i></a> &nbsp;
                                        <!-- Edit Button -->
                                        <a class="text-danger" href='<?php echo base_url(); ?>staff/edit_leads/<?php echo $post['order_id']; ?>'><i class="fas fa-pencil-alt"></i></a>
                                      </td>
