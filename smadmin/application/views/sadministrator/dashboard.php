            ...
            <div class="row">
              <div class="col-lg-12 col-sm-12 col-md-12 col-xl-12">
                <div class="card overflow-hidden bg-transparent" >
                  <div class="card-body">
                    <div class="row">
                      <div class="vh-100 col text-center">
                        <h3 class="mb-2 fw-semibold"></h3>
                        <img alt="img" class="mb-2 profile-user cover-image" src="<?php echo base_url(); ?>assets/adminz/assets/images/brand/logo-3.png">
                        <p class="text-muted fs-13 mb-0"></p>
