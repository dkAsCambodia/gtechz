                    ...
                    <div class="row p-5 border-bottom">
                      <div class="col-sm-12 col-md-12 col-xl-3">
                        <div class="form-group">
                          ...
                          <select class="form-control select2 form-select select2-hidden-accessible text-dark" id="merchantid" name="merchantid" disabled required data-placeholder="---" tabindex="-1" aria-hidden="true">
                            <option value="">---</option>
                      ...
                      <div class="col-sm-12 col-md-12 col-xl-3">
                        <div class="form-group">
                          ...
                          <input type="text" readonly required id="mbwirefee" name="mbwirefee"  class="form-control text-dark" value="<?php echo $post['mbwirefee'];  ?>" placeholder="1">
                          <div class="valid-feedback">Looks good!</div>
                      ...
                      <div class="col-sm-12 col-md-12 col-xl-3">
                        <div class="form-group">
                          ...
                          <input type="text" readonly required id="mbmonthlyfee" name="mbmonthlyfee"  class="form-control text-dark" value="<?php echo $post['mbmonthlyfee'];  ?>" placeholder="1">
                          <div class="valid-feedback">Looks good!</div>
                      ...
                      <div class="col-sm-12 col-md-12 col-xl-3">
                        <div class="form-group">
                          ...
                          <input type="text" readonly required id="mbwithdraw_minamt" name="mbwithdraw_minamt"  class="form-control text-dark" value="<?php echo $post['mbwithdraw_minamt'];?>" placeholder="1">
                          <div class="valid-feedback">Looks good!</div>
                      ...
                      <div class="col-sm-12 col-md-12 col-xl-3">
                        <div class="form-group">
                          ...
                          <input type="text" readonly required id="mbwithdraw_maxamt" name="mbwithdraw_maxamt" class="form-control text-dark" value="<?php echo $post['mbwithdraw_maxamt'];?>" placeholder="20000">
                          <div class="valid-feedback">Looks good!</div>
                        ...
                        <div class="form-group">
                          <label class="form-label text-muted">Frozen Balance:</label>
                            <div class="input-group mb-3">
                              ...
                              <input aria-label="Amount (to the nearest dollar)" class="form-control" placeholder="100" id="basic-addon3" readonly required id="mbfrozenbalance" name="mbfrozenbalance"  type="number" value="<?php echo $post['mbfrozenbalance'];?>" >
                      ...
                      <div class="col-sm-12 col-md-12 col-xl-2">
                        <div class="form-group">
                          ...
                          <select class="form-control select2-show-search form-select select2-hidden-accessible text-dark" id="requestfunds" disabled name="requestfunds" required data-placeholder="---" tabindex="-1" aria-hidden="true">
                            <option value="">---</option>
                      ...
                      <div class="col-sm-12 col-md-12 col-xl-2">
                        <div class="form-group">
                          ...
                          <select class="form-control select2-show-search form-select select2-hidden-accessible text-dark" id="mbmoto" name="mbmoto" disabled required data-placeholder="---" tabindex="-1" aria-hidden="true">
                            <option value="">---</option>
                      ...
                      <div class="col-sm-12 col-md-12 col-xl-2">
                        <div class="form-group">
                          ...
                          <select class="form-control select2-show-search form-select select2-hidden-accessible text-dark" id="mbpayoutgateway" disabled name="mbpayoutgateway" required data-placeholder="---" tabindex="-1" aria-hidden="true">
                            <option value="">---</option>
                    ...
                    <div class="row p-5 border-bottom">
                      <div class="col-sm-12 col-md-12 col-xl-6">
                        <div class="form-group">
                          ...
                          <div class="input-group" id="client-username">
                            <input type="text" readonly class="form-control text-dark" value="<?php echo $post['mbname'];  ?>" required id="mbname" name="mbname" placeholder="Enter Business Name">
                            <div class="valid-feedback">Looks good!</div>
                      ...
                      <div class="col-sm-12 col-md-12 col-xl-3">
                        <div class="form-group">
                          ...
                          <select class="form-control select2-show-search form-select select2-hidden-accessible text-dark" id="mbcategory" disabled name="mbcategory" required data-placeholder="---" tabindex="-1" aria-hidden="true">
                            <option value="">---</option>
                      ...
                      <div class="col-sm-12 col-md-12 col-xl-3">
                        <div class="form-group">
                         <label class="form-label text-muted">Business Sub Category:</label>
                          <select class="form-control select2-show-search form-select select2-hidden-accessible text-dark" id="mbsubcategory" disabled name="mbsubcategory" required data-placeholder="---" tabindex="-1" aria-hidden="true">
                            <option value="">---</option>
                      ...
                      <div class="col-sm-12 col-md-12 col-xl-6">
                        <div class="form-group">
                          ...
                          <div class="input-group" id="company-website">
                            <input type="text" class="form-control text-dark" value="<?php echo $post['mbwebsite'];  ?>" required readonly id="mbwebsite" name="mbwebsite" placeholder="ex: http://www.domain.com/">
                            <div class="valid-feedback">Looks good!</div>
                            <div class="invalid-feedback">Please Enter Business Name!</div>
                          </div>
                        </div>
                      ...
                      <div class="col-sm-12 col-md-12 col-xl-3">
                        <div class="form-group">
                          ...
                          <div class="input-group" id="company-gstnumber">
                            <input type="text" class="form-control text-dark" readonly value="<?php echo $post['mbcinno'];  ?>" required id="mbcinno" name="mbcinno" placeholder="Enter VAT/Licence Number">
                            <div class="valid-feedback">Looks good!</div>
                      ...
                      <div class="col-sm-12 col-md-12 col-xl-3">
                        <div class="form-group">
                          ...
                          <div class="input-group" id="company-phonenumber">
                            <input type="number" class="form-control text-dark" value="<?php echo $post['mbcontact'];  ?>" readonly required id="mbcontact" name="mbcontact" placeholder="Enter Phone Number">
                            <div class="valid-feedback">Looks good!</div>
                      ...
                      <div class="col-sm-12 col-md-12 col-xl-12">
                        <div class="form-group">
                          ...
                          <textarea class="form-control" value="<?php echo $post['mbaddress'];  ?>" required id="mbaddress" readonly name="mbaddress" cols="30" rows="1" placeholder="Office Name, Building No, Street, Lane No, City"><?php echo $post['mbaddress'];  ?></textarea>
                          <div class="valid-feedback">Looks good!</div>
                      ...
                      <div class="col-sm-12 col-md-12 col-xl-12">
                        <div class="form-group">
                          ...
                          <textarea class="form-control" value="<?php echo set_value('mbdescri');  ?>" required id="mbdescri" readonly name="mbdescri" cols="30" rows="1" placeholder="Business Activities"><?php echo $post['mbdescri'];  ?></textarea>
                          <div class="valid-feedback">Looks good!</div>
                      ...
                      <div class="col-sm-12 col-md-12 col-xl-3">
                        <div class="form-group">
                          ...
                          <div class="input-group" id="company-city">
                            <input type="text" readonly class="form-control text-dark" value="<?php echo set_value('mbcity');  ?>" value="<?php echo $post['mbcity'];  ?>" placeholder="City" required id="mbcity" name="mbcity"/>
                            <div class="valid-feedback">Looks good!</div>
                      ...
                      <div class="col-sm-12 col-md-12 col-xl-3">
                        <div class="form-group">
                          ...
                          <div class="input-group" id="company-state">
                            <input type="text" class="form-control text-dark" value="<?php echo $post['mbstate'];  ?>" placeholder="State" readonly required id="mbstate" name="mbstate">
                            <div class="valid-feedback">Looks good!</div>
                      ...
                      <div class="col-sm-12 col-md-12 col-xl-3">
                        <div class="form-group">
                          ...
                          <div class="input-group" id="company-postalcode">
                            <input type="text" readonly class="form-control text-dark" value="<?php echo $post['mbzipcode'];  ?>" placeholder="Postal Code" required id="mbzipcode" name="mbzipcode"/> 
                            <div class="valid-feedback">Looks good!</div>
                      ...
                      <div class="col-sm-12 col-md-12 col-xl-2">
                        <div class="form-group">
                          ...
                          <select class="form-control select2 form-select select2-hidden-accessible text-dark" required id="mbimstype" disabled name="mbimstype" data-placeholder="---" tabindex="-1" aria-hidden="true">
                            <option value="">---</option>
                      ...
                      <div class="col-sm-12 col-md-12 col-xl-4">
                        <div class="form-group">
                          ...
                          <div class="input-group" id="company-city">
                            <input type="text" class="form-control text-dark" value="<?php echo $post['mbimsid'];  ?>" required id="mbimsid" name="mbimsid" readonly  placeholder="Business IM’S-ID:">
                            <div class="valid-feedback">Looks good!</div>
                      ...
                      <div class="col-sm-12 col-md-12 col-xl-3">
                        <div class="form-group">
                          ...
                          <select class="form-control select2 form-select select2-hidden-accessible text-dark" required id="mbdocumentype" disabled name="mbdocumentype" data-placeholder="---" tabindex="-1" aria-hidden="true">
                            <option value="">---</option>
                      ...
                      <div class="col-sm-12 col-md-12 col-xl-3">
                        <div class="form-group">
                          ...
                          <select class="form-control select2-show-search form-select select2-hidden-accessible text-dark" id="mbstatus" disabled name="mbstatus" required data-placeholder="---" tabindex="-1" aria-hidden="true">
                            <option value="">---</option>
                      ...
                      <div class="col-sm-12 col-md-12 col-xl-12">
                        <div class="form-group">
                          ...
                          <div class="input-group btn btn-outline-primary" id="company-city" >
                            <input type="file" readonly disabled id="mbdocumen" readonly name="mbdocumen" value="<?php echo $post['mbdocumen'];  ?>" class="dropify" data-height="100" />  
                          </div>
                          <div class="valid-feedback">Looks good!</div>
