            ...
            <div class="page-header">
              ...
              <div class="ms-auto pageheader-btn">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"  aria-current="page"><a href="<?php echo base_url('sadministrator/merchants/create'); ?>">Create Merchant</a></li>
                </ol>
              </div>
            </div>
            <!-- PAGE-HEADER END -->
                        ...
                        <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom  w-100" >
                          <thead>
                            <tr>
                              ...
                              <th class="bg-transparent border-bottom-0">Stores</th>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="text-muted fs-12 fw-semibold"><?php echo $blog['mname']; ?></td>
                              <td class="text-muted fs-12 fw-semibold"><?php echo $blog['musername']; ?></td>
                              <td class="text-muted fs-12 fw-semibold"><?php echo $blog['mstores']; ?></td>
                              <td class="text-muted fs-12 fw-semibold"><?php echo $blog['role_id']; ?></td>
                              <td class="text-muted fs-12 fw-semibold">
                                <a href="#" class="text-dark"><button type="button" class="btn btn-outline-warning"><i class="fe fe-link me-2"></i><?php echo $blog['role_id']; ?></button></a>
                              </td>
                              <td class="text-muted fs-12 fw-semibold">
                                <div class="d-flex align-items-stretch">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-start  btn btn-outline">
                                    <a class="dropdown-item" href="<?php echo base_url(); ?>sadministrator/merchants/edit-merchant/<?php echo $blog['id']; ?>"><i class="fe fe-edit-2 fs-13  me-2"></i> Edit</a>
                                    <a class="dropdown-item" href="#modal-dialog" data-bs-target="#viewmerchants<?php echo $blog['id']; ?>" data-bs-toggle="modal" title="" data-bs-original-title=""><i class="fe fe-eye fs-13  me-2"></i> View</a>
                                    <a class="dropdown-item" href="#"><i class="fe fe-log-in fs-13  me-2"></i> Login</a>
                                    <?php if($blog['status'] == 1){ ?>
                                    <a class="dropdown-item" href="<?php echo base_url(); ?>sadministrator/enableoth/<?php echo $blog['id']; ?>?table=<?php echo base64_encode('m_merchants'); ?>"><i class="fe fe-check-circle fs-13 me-2"></i> Active</a>
                                    <?php }else{ ?>
                                    <a class="dropdown-item" href="<?php echo base_url(); ?>sadministrator/desableoth/<?php echo $blog['id']; ?>?table=<?php echo base64_encode('m_merchants'); ?>"><i class="fe fe-x-circle fs-13 me-2"></i> Hold</a>
                                    <?php } ?>
                                  </div>
                                </div>
                              </td>
