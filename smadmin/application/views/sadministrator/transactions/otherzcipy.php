<!--app-content open-->
      <div class="app-content main-content mt-0">
        <div class="side-app">
          ...
          <form method="POST" action="<?php echo base_url('sadministrator/transactions/transactions-others'); ?>">
            <div class="row p-3 border-bottom mx-auto bg-white rounded-2">
              ...
              <div class="col-sm-12 col-md-12 col-xl-4">
                ...
                <div class="btn-list text-start mt-0">
                  <button class="btn btn-primary bg-gray-900" name="submitForm" value="viewdate" type="submit"> <i class="fe fe-check-circle"></i> Search</button>
                  <button class="btn btn-warning bg-gray-800" name="submitForm" value="viewall" type="submit"> <i class="fe fe-check-circle p-1"></i>All</button>
                  <button class="btn btn-warning bg-gray-800" name="submitForm" value="viewtoday" type="submit"> <i class="fe fe-check-circle p-1"></i>Today</button>
                </div>
              </div>
                    ...
                    <div class="card-body">
                      <p class="text-muted"></p>
                        <div class="row mb-2">
                          ...
                          <div class="col-md-8">
                            <input class="form-control text-muted" readonly name="deposit_info" id="deposit_info" placeholder="0" type="text" value="<?php if($cashcounts[0]!="" ) echo(number_format($cashcounts[0]['totprice'],2, '.', '')); else echo "0"; ?>">
                          </div>
                        </div>
                        <!-- <div class="row mb-2">
                    ...
                    <div class="card-body">
                      <p class="text-muted"></p>
                        <div class="row mb-2">
                          ...
                          <div class="col-md-7">
                            <input class="form-control text-muted" readonly name="withdrawal_info" id="withdrawal_info" placeholder="0" type="text" value="<?php if (count($cashcounts)>2){if($cashcounts[2]!="") echo(number_format($cashcounts[2]['totprice'],2, '.', ''));  else echo "0"; } else echo "0"; ?>">
                          </div>
                        </div>
                        <!-- <div class="row mb-2">
                    ...
                    <div class="card-body">
                      <p class="text-muted"></p>
                        <div class="row mb-2">
                          <label for="firstName" class="col-md-5 form-label">Deposit</label>
                          <div class="col-md-7">
                            <input class="form-control text-muted" readonly name="total_deposit_info" id="total_deposit_info" placeholder="0" type="text" value="<?php if (count($cashcounts)>1){ if($cashcounts[0]!="" && $cashcounts[1]!="") echo(number_format(($cashcounts[0]['totcount']+$cashcounts[1]['totcount']),2, '.', ''));  else echo "0"; } else echo "0"; ?>">
                          </div>
                        </div>
                        <div class="row mb-2">
                          <label for="lastName" class="col-md-5 form-label">Withdrawal</label>
                          <div class="col-md-7">
                            <input class="form-control text-muted" readonly name="total_withdrawal_info" id="total_withdrawal_info" placeholder="0" type="text" value="<?php if (count($cashcounts)>3){ if($cashcounts!="") echo(number_format(($cashcounts[2]['totcount']+$cashcounts[3]['totcount']),2, '.', '')); else echo "0"; } else echo "0"; ?>">
                          </div>
                        </div>
                        ...
                        <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom  w-100" >
                          <thead>
                            <tr>
                              ...
                              <th class="bg-transparent border-bottom-0">Store-ID</th>
                              <th class="bg-transparent border-bottom-0">TRN-ID</th>
                              <th class="bg-transparent border-bottom-0">Ref-ID</th>
