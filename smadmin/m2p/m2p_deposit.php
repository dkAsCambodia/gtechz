  ...
  <div class="container">
    <div class="row clearfix">
      ...
      <div class="span10 offset1">
        <div class="clearfix">
          <h2>M2P Deposit USD & CNY</h2>
         <hr>  
          <form action="https://gtechz.implogix.com/m2p/m2p_deposit_response.php" method="POST" class="form-horizontal">
              ...
              <div class="control-group">
                <label class="control-label" for="">PaymentCurrency</label>
                <div class="controls">
                  <input name="paymentCurrency" id="paymentCurrency" type="text" value="USX" class="input-xlarge">
                </div>
              </div>              
              <div class="control-group">
