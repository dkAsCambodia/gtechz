<?php
	...
	//h2p
	//$MerchantOg="G0313";
	//$Merchanttest="INT0651";
	$ClientIP =(isset($_SERVER['HTTP_X_FORWARDED_FOR'])?$_SERVER['HTTP_X_FORWARDED_FOR']:$_SERVER['REMOTE_ADDR']);
	$Merchant="G0313";
	$Currency="THB";
	$Customer = "ZCust".time().generateRandomString(3);
	//$Reference=time();
	$Reference="ZTRN".time().generateRandomString(3);
	$Amount="101.00";
	$Note="Test Purpose";
	...
	$Language="en-us";
	$Bank="PPTP";
	$CompanyName="Testing Zaffran PSP";
	$FrontURI="https://www.zaffranpsp.com/api/HELP2PAY/h2pay-checkout-response.php";
	$BackURI="https://www.zaffranpsp.com/api/HELP2PAY/h2pay-checkout-status.php";
	$SecurityCode="SRlRgBhfqQTLfgdvvk8c";
	$Keystring= $Merchant.$Reference.$Customer.$Amount.$Currency.$Datetime.$SecurityCode.$ClientIP;
	...
	//echo $Keystring;
	$Key= MD5($Keystring);
	//print_r(MD5($Keystring));
/*	echo "MerchantID- ".$MerchantOg.'<br/><br/>';
	echo "SecurityCode- ".$SecurityCode.'<br/><br/>';
	echo "Datetime- ".$dated.'<br/>';
	echo "Datetime-Converted ".$Datetime.'<br/><br/>';
	echo "Keystring-before MD5(".$Keystring.')<br/><br/>';
	echo "Key-Generated ".$Key.'<br/><br/>';*/
	//h2p

	
	$outtext="Generated Hash Key - URL will show here. MD5(".$Keystring.")";
	$outtextb="";
	...
	function terminalauthcheckout(){
		ob_start();
	$gateway_urlpayment="https://api.safepaymentapp.com/MerchantTransfer";
	//$gateway_urlpayment="https://api.testingzone88.com/MerchantTransfer";
	global $Merchant,$Currency,$Customer,$Reference,$Key,$Amount,$Note,$dated,$FrontURI,$BackURI,$Language,$Bank,$ClientIP;
	$dataPost=array();
	$dataPost["Merchant"]	=  $Merchant;
	$dataPost["Currency"]	=  $Currency;
	$dataPost["Customer"]	=  $Customer;
	$dataPost["Reference"] = $Reference;
	$dataPost["Key"]	=  $Key;
	$dataPost["Amount"]	=  $Amount;
	$dataPost["Note"]	=  $Note;
	$dataPost["Datetime"]	=  $dated;
	$dataPost["FrontURI"]	=  $FrontURI;
	$dataPost["BackURI"]	=  $BackURI;
	$dataPost["Language"]	=  $Language;
	$dataPost["Bank"]	=  $Bank;
	$dataPost["ClientIP"]	=  $ClientIP;
	//var_dump($dataPost);

	$outpay=http_build_query($dataPost);
	//var_dump($outpay);
	//$outpay=http_build_query($dataPost);
	//var_dump($outpay);
		/*$data =array();
    ...
    $ch = curl_init();
		curl_setopt_array($ch, array(
			CURLOPT_URL => $gateway_urlpayment,
    ...
    if (curl_errno($ch)) {
      ...
      $outtext="You have some error in your request. Please try again later..";
      //echo 'errstr'.$errstr;
    }
    else{ 	
	...
	if(array_key_exists('paynow',$_POST)){
		//echo "hi";
		//terminalauthcheckout();
		$outtextb=terminalauthcheckout();
		//echo $outtextb;
		//$abg=parse_url($outtextb);
		//echo "abg".$abg;
		if($outtextb){
		    //header("Location:".$outtextb);
		    echo $outtextb;
		}
   }
?>
...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- TITLE -->
		<title>Zaffran PSP – Payment Service Provider</title>
							...
							<div class="section pb-5">
								<div class="container px-5 px-md-0">
									<div class="row text-center">
										<div class="col-lg-12">
											<h3 class="header-family">Demo Checkout Page- HELP2PAY</h3>
								...
								<div class="col-md-10 col-lg-8 col-xl-6 mx-auto d-block bg-white">
									<div class="card bg-primary">
										<div class="card-header border-bottom ">
											<h3 class="card-title text-center text-white ">Merchant-  <?php echo $Merchant; ?> </h3>
										</div>
										<div class="card-body bg-white">
											<p class="text-muted"><?php ob_start(); echo $outtext; ?></p>
											<form class="form-horizontal" method="post" action="#">
												<div class="row mb-4">
													<label for="firstName" class="col-md-3 form-label">Merchant</label>
													<div class="col-md-9">
														<input class="form-control" name="Merchant" id="Merchant" placeholder="Enter your MCPTID" value="<?php echo $Merchant; ?>" readonly type="text">
													</div>
												</div>
												<div class="row mb-4">
													<label for="lastName" class="col-md-3 form-label">Currency</label>
													<div class="col-md-9">
														<input class="form-control" name="Currency" id="Currency" placeholder="Enter your Currency" value="<?php echo $Currency; ?>" readonly type="text">
													</div>
												</div>
												<div class="row mb-4">
													<label for="lastName" class="col-md-3 form-label">Customer</label>
													<div class="col-md-9">
														<input class="form-control" name="Customer" id="Customer" placeholder="Enter your Currency" value="<?php echo $Customer; ?>" readonly type="text">
													</div>
												</div>
												<div class="row mb-4">
													<label for="firstName" class="col-md-3 form-label">Reference ID</label>
													<div class="col-md-9">
														<input class="form-control" name="Reference" id="Reference" placeholder="Enter Reference ID" value="<?php echo $Reference; ?>" readonly type="text">
													</div>
												</div>
												<div class="row mb-4">
													<label for="firstName" class="col-md-3 form-label">Key</label>
													<div class="col-md-9">
														<input class="form-control" name="Key" id="Key" placeholder="Enter Key" value="<?php echo $Key; ?>" readonly type="text">
													</div>
												</div>
												<div class="row mb-4">
													<label for="" class="col-md-3 form-label">Amount</label>
													<div class="col-md-9">
														<input class="form-control" name="Amount" id="Amount" placeholder="Enter your Amount" value="<?php echo $Amount; ?>" type="text">
													</div>
												</div>
												<div class="row mb-4">
													<label for="" class="col-md-3 form-label">Note</label>
													<div class="col-md-9">
														<input class="form-control" name="Note" id="Note" placeholder="Enter your Note" value="<?php echo $Note; ?>" type="text">
													</div>
												</div>
												<div class="row mb-4">
													<label for="" class="col-md-3 form-label">Datetime</label>
													<div class="col-md-9">
														<input class="form-control" name="Datetime" id="Datetime" placeholder="Enter Datetime" value="<?php echo $dated; ?>" type="text">
													</div>
												</div>
												<div class="row mb-2">
													<label for="" class="col-md-3 form-label">FrontURI URL</label>
													<div class="col-md-9">
														<input class="form-control text-10" name="FrontURI" id="FrontURI" placeholder="Enter FrontURI" type="text" value="<?php echo $FrontURI; ?>">
													</div>
												</div>
												<div class="row mb-2">
													<label for="" class="col-md-3 form-label">BackURI URL</label>
													<div class="col-md-9">
														<input class="form-control text-10" name="BackURI" id="BackURI" placeholder="Enter BackURI" type="text" value="<?php echo $BackURI; ?>">
													</div>
												</div>
												<div class="row mb-4">
													<label for="" class="col-md-3 form-label">Language</label>
													<div class="col-md-9">
														<input class="form-control" name="Language" id="Language" placeholder="Enter your Note" value="<?php echo $Language; ?>" type="text">
													</div>
												</div>
												<div class="row mb-4">
													<label for="" class="col-md-3 form-label">Bank</label>
													<div class="col-md-9">
														<input class="form-control" name="Bank" id="Bank" placeholder="Enter your Bank" value="<?php echo $Bank; ?>" type="text">
													</div>
												</div>
												<div class="row mb-4">
													<label for="" class="col-md-3 form-label">ClientIP</label>
													<div class="col-md-9">
														<input class="form-control" name="ClientIP" id="ClientIP" placeholder="Enter ClientIP" value="<?php echo $ClientIP; ?>" type="text">
													</div>
												</div>
												<div class="row mb-4">
													<label for="" class="col-md-3 form-label">CompanyName</label>
													<div class="col-md-9">
														<input class="form-control" name="CompanyName" id="CompanyName" placeholder="Enter CompanyName" value="<?php echo $CompanyName; ?>" type="text">
													</div>
												</div>
												<!-- <div class="row mb-4">
											...
											<footer class="main-footer px-0 pb-0">
												<div class="row ">
													<div class="col-xl-8 col-lg-12 col-md-12 footer1">Copyright © 2023 <a
															href="javascript:void(0)">ZaffranPSP</a>. Designed with <span
