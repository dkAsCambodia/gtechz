...
function checkout(){
	...
	$pramPost['payin_notify_url']	='http://gtechz.implogix.com/payin/payin_notify_url.php'; // Notify URL
	$pramPost['payin_success_url']	='http://gtechz.implogix.com/payin/payin_success_url.php'; // Success CallBack URL
	$pramPost['payin_error_url']	='http://gtechz.implogix.com/payin/payin_error_url.php';
	...
	elseif($status=="completed" || $status=="0000" || $status=="success" || $status=="test" || $status=="test transaction"){
		$redirecturl = $curlPost["payin_success_url"];
										...
										<div class="card-body bg-white">
											...
											<form class="form-horizontal" enctype="multipart-formdata" method="post" action="#">
												...
												<div class="row mb-4">
													...
													<div class="col-md-9">
														<input class="form-control" required name="currency" id="currency" placeholder="Enter your Currency" value="THB" readonly type="text">
													</div>
												</div>
												<div class="row mb-4">
													...
													<div class="col-md-9">
														<select class="form-control select2-show-search form-select  text-dark" id="bank_type" name="bank_type" required data-placeholder="---" tabindex="-1" aria-hidden="true">
                            								<option value="">---</option>
                            								<option value="PPTP">THAI QR</option>
												...
												<div class="row mb-4">
													...
													<div class="col-md-9">
														<input class="form-control" required name="customer_city" id="customer_city" placeholder="" type="text" value="Customer City">
													</div>
												</div>
												<div class="row mb-4">
