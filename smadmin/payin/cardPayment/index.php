...
function checkout(){
    ...
    if($_POST['source_type']=='xprizo'){     
			$payin_url=$baseurl."/api/V16/";      //XPRIZO
							...
							<div class="section pb-5">
								<div class="container px-5 px-md-0">
									<div class="row text-center">
										<div class="col-lg-12">
											<h3 class="header-family">Merchant - Card Payment</h3>
										...
										<div class="card-body bg-white">
											...
											<form class="form-horizontal" enctype="multipart-formdata" method="post" action="#">
                                                ...
                                                <div class="row mb-4">
													...
													<div class="col-md-9">
														<input class="form-control" required name="customer_name" id="customer_name" value="dk" placeholder="Enter Card Holder Name" type="text" value="">
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group text-center">
														<button class="card-btn btn btn-primary col-6 m-4 py-2" name="paynow" id="paynow" type="submit">Pay Now</button>
													</div>
												</div>
