...
function checkout(){
	...
	if($_POST['source_type']=='source1'){
		$payin_url=$baseurl."/api/V1/";   //QT
	}else if($_POST['source_type']=='source2'){     
			$payin_url=$baseurl."/api/V5/";      //powerpay
	}else if($_POST['source_type']=='source3'){     
			$payin_url=$baseurl."/api/V3/";      //H2p
	}else if($_POST['source_type']=='source4'){     
			$payin_url=$baseurl."/api/V4/";      //M2p
	}else if($_POST['source_type']=='source5'){     
			$payin_url=$baseurl."/api/V12/";      //Akurateck 
	...
	/*if($_POST['source_type']=="source2"){
		$pramPost['customer_bank_name']	= 'PPTP';
	}
	if($_POST['source_type']=="source4"){
		$pramPost['customer_bank_name']	= 'SCB';
	}
	if($_POST['source_type']=="source1"){
		$pramPost['customer_bank_name']	= 'SCB';
	}*/
	//$pramPost['customer_bank_name']	= 'PPTP'; //Bank Code//PPTP,SCB
	if($_POST['currency_namez']=="USD(Cambodia)"){
	...
	//$pramPost['customer_bank_code']	= $_POST['currency_namez']; // Currency Code, THB
	...
	$pramPost['payin_notify_url']	='https://gtechz.implogix.com/payin/payin_notify_url.php'; // Notify URL
	$pramPost['payin_success_url']	='https://gtechz.implogix.com/payin/payin_success_url.php'; // Success CallBack URL
	$pramPost['payin_error_url']	='https://gtechz.implogix.com/payin/payin_error_url.php';
...
<html lang="en" dir="ltr">
	...
	<body class="ltr app horizontal landing-page">
							...
							<div class="section pb-5">
								<div class="container px-5 px-md-0">
									<div class="row text-center">
										<div class="col-lg-12">
											<h3 class="header-family">Merchant - Checkout</h3>
									...
									<div class="card bg-primary">
										...
										<div class="card-body bg-white">
											...
											<form class="form-horizontal" enctype="multipart-formdata" method="post" action="#">
												...
												<div class="row mb-4">
													<label for="" class="col-md-3 form-label bank_account_field">Bank Account Number</label>
													<div class="col-md-9">
														<input class="form-control bank_account_field"  name="customer_account_number" id="customer_account_number" placeholder="Enter Bank Account Number" value="" type="text">
													</div>
												</div>
												<div class="row mb-4">
												...
												<div class="row mb-4">
													...
													<div class="col-md-9">
														<input class="form-control" required name="customer_city" id="customer_city" placeholder="Customer City" type="text" value="">
													</div>
												</div>
												<div class="row mb-4">
												...
												<div class="row mb-4">
													...
													<div class="col-md-9">
														<select class="form-control select2-show-search form-select  text-dark" id="customer_country" name="customer_country" required data-placeholder="---" tabindex="-1" aria-hidden="true">
												...
												<div class="row mb-4">
													<label for="" class="col-md-3 form-label">Product Detail</label>
													<div class="col-md-9">
														<input class="form-control" name="product_name" id="product_name" placeholder="Enter Product Name" type="text" value="test Item" required>
													</div>
												</div>
		...
		<script src="https://gtechz.implogix.com/payin/js/custom.js"></script>
