...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- TITLE -->
		<title>Zaffran – Payment Service Provider</title>
							...
							<div class="section pb-5">
								<div class="container px-5 px-md-0">
									<div class="row text-center">
										<div class="col-lg-12">
											<h3 class="header-family">Responses Status Page</h3>
										...
										<div class="card-body bg-white">
											...
											<form class="form-horizontal">
												<div class="row mb-4">
													...
													<div class="col-md-9">
														<input class="form-control" name="referenceNo" id="referenceNo" placeholder="Enter Reference ID" value="<?php echo $responsez['referenceNo']; ?>" readonly type="text">
													</div>
												</div>
												<div class="row mb-4">
												...
												<div class="row mb-4">
													<label for="" class="col-md-3 form-label">Transaction Id</label>
													<div class="col-md-9">
														<input class="form-control" name="transactionId" id="transactionId" placeholder="Enter your transactionId" type="text" value="<?php echo $responsez['transactionId']; ?>">
													</div>
												</div>
												<div class="row mb-2">
													<label for="" class="col-md-3 form-label">responseCode</label>
													<div class="col-md-9">
														<input class="form-control" name="responseCode" id="responseCode" placeholder="Enter responseCode" type="text" value="<?php echo $responsez['responseCode']; ?>">
													</div>
												</div>
												<div class="row mb-2">
													<label for="" class="col-md-3 form-label">responseMsg</label>
													<div class="col-md-9">
														<input class="form-control" name="responseMsg" id="responseMsg" placeholder="Enter response Msg" type="text" value="<?php echo $responsez['responseMsg']; ?>">
													</div>
												</div>
												<div class="row mb-4">
													<label for="" class="col-md-3 form-label">brandName</label>
													<div class="col-md-9">
														<input class="form-control" name="brandName" id="brandName" placeholder="Enter brandName" type="text" value="<?php echo $responsez['brandName']; ?>">
													</div>
												</div>
											...
											<footer class="main-footer px-0 pb-0">
												<div class="row ">
													<div class="col-xl-8 col-lg-12 col-md-12 footer1">Copyright © 2023 <a
															href="javascript:void(0)">Gtechz</a>. Designed with <span
